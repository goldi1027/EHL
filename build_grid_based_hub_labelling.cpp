...
void build_ebhl_parallel(string dir, string map, int grid_size){
...
#pragma omp critical
    ...
    cout << "memory: " << hub_size/(double)1000000 << endl;

    std::cout<<std::fixed << setprecision(8) <<"hub labelling size in "<< hub_size << " bytes"<< std::endl;
    ...
    string output_path = "dataset/ehl/" + dir + "/" + map + ".nt_gridlabel_"+ to_string(grid_size);
